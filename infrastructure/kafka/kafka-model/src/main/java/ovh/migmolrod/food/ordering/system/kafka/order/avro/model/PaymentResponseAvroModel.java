...
public class PaymentResponseAvroModel extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
	...
	public static final org.apache.avro.Schema SCHEMA$ = new org.apache.avro.Schema.Parser().parse("{\"type" +
			"\":\"record" +
			"\",\"name\":\"PaymentResponseAvroModel\",\"namespace\":\"ovh.migmolrod.food.ordering.system.kafka.order" +
			".avro.model\",\"fields\":[{\"name\":\"id\",\"type\":{\"type\":\"string\",\"logicalType\":\"uuid\"}}," +
			"{\"name\":\"sagaId\",\"type\":{\"type\":\"string\",\"logicalType\":\"uuid\"}},{\"name\":\"paymentId\"," +
			"\"type\":{\"type\":\"string\",\"logicalType\":\"uuid\"}},{\"name\":\"customerId\"," +
			"\"type\":{\"type\":\"string\",\"logicalType\":\"uuid\"}},{\"name\":\"orderId\"," +
			"\"type\":{\"type\":\"string\",\"logicalType\":\"uuid\"}},{\"name\":\"price\"," +
			"\"type\":{\"type\":\"bytes\",\"logicalType\":\"decimal\",\"precision\":10,\"scale\":2}}," +
			"{\"name\":\"createdAt\",\"type\":{\"type\":\"long\",\"logicalType\":\"timestamp-millis\"}}," +
			"{\"name\":\"paymentStatus\",\"type\":{\"type\":\"enum\",\"name\":\"PaymentStatus\"," +
			"\"symbols\":[\"COMPLETED\",\"CANCELLED\",\"FAILED\"]}},{\"name\":\"failureMessages\"," +
			"\"type\":{\"type\":\"array\",\"items\":{\"type\":\"string\",\"avro.java.string\":\"String\"}}}]}");
	private static final long serialVersionUID = 7699670871672344021L;
	...
	private ovh.migmolrod.food.ordering.system.kafka.order.avro.model.PaymentStatus paymentStatus;
	...
	public PaymentResponseAvroModel(java.lang.String id, java.lang.String sagaId, java.lang.String paymentId,
	                                ...
	                                ovh.migmolrod.food.ordering.system.kafka.order.avro.model.PaymentStatus paymentStatus, java.util.List<java.lang.String> failureMessages) {
		this.id = id;
		this.sagaId = sagaId;
	 ...
	 */
	public static ovh.migmolrod.food.ordering.system.kafka.order.avro.model.PaymentResponseAvroModel.Builder newBuilder() {
		return new ovh.migmolrod.food.ordering.system.kafka.order.avro.model.PaymentResponseAvroModel.Builder();
	}
	 ...
	 * @return A new PaymentResponseAvroModel RecordBuilder
	 */
	public static ovh.migmolrod.food.ordering.system.kafka.order.avro.model.PaymentResponseAvroModel.Builder newBuilder(ovh.migmolrod.food.ordering.system.kafka.order.avro.model.PaymentResponseAvroModel.Builder other) {
		if (other == null) {
			return new ovh.migmolrod.food.ordering.system.kafka.order.avro.model.PaymentResponseAvroModel.Builder();
		} else {
			return new ovh.migmolrod.food.ordering.system.kafka.order.avro.model.PaymentResponseAvroModel.Builder(other);
		}
	}
	 ...
	 * @return A new PaymentResponseAvroModel RecordBuilder
	 */
	public static ovh.migmolrod.food.ordering.system.kafka.order.avro.model.PaymentResponseAvroModel.Builder newBuilder(ovh.migmolrod.food.ordering.system.kafka.order.avro.model.PaymentResponseAvroModel other) {
		if (other == null) {
			return new ovh.migmolrod.food.ordering.system.kafka.order.avro.model.PaymentResponseAvroModel.Builder();
		} else {
			return new ovh.migmolrod.food.ordering.system.kafka.order.avro.model.PaymentResponseAvroModel.Builder(other);
	...
	public void put(int field$, java.lang.Object value$) {
		switch (field$) {
			...
			case 6:
				...
				break;
			case 7:
				paymentStatus = (ovh.migmolrod.food.ordering.system.kafka.order.avro.model.PaymentStatus) value$;
				break;
			case 8:
	 ...
	 */
	public ovh.migmolrod.food.ordering.system.kafka.order.avro.model.PaymentStatus getPaymentStatus() {
		return paymentStatus;
	}
	 ...
	 * @param value the value to set.
	 */
	public void setPaymentStatus(ovh.migmolrod.food.ordering.system.kafka.order.avro.model.PaymentStatus value) {
	...
	public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<PaymentResponseAvroModel>
		 ...
		 * @param other The existing Builder to copy.
		 */
		private Builder(ovh.migmolrod.food.ordering.system.kafka.order.avro.model.PaymentResponseAvroModel.Builder other) {
			super(other);
		 ...
		 * @param other The existing instance to copy.
		 */
		private Builder(ovh.migmolrod.food.ordering.system.kafka.order.avro.model.PaymentResponseAvroModel other) {
			super(SCHEMA$, MODEL$);
			if (isValidValue(fields()[0], other.id)) {
				this.id = data().deepCopy(fields()[0].schema(), other.id);
		 ...
		 * @return This builder.
		 */
		public ovh.migmolrod.food.ordering.system.kafka.order.avro.model.PaymentResponseAvroModel.Builder setId(java.lang.String value) {
		 ...
		 * @return This builder.
		 */
		public ovh.migmolrod.food.ordering.system.kafka.order.avro.model.PaymentResponseAvroModel.Builder clearId() {
			id = null;
		 ...
		 * @return This builder.
		 */
		public ovh.migmolrod.food.ordering.system.kafka.order.avro.model.PaymentResponseAvroModel.Builder setSagaId(java.lang.String value) {
		 ...
		 * @return This builder.
		 */
		public ovh.migmolrod.food.ordering.system.kafka.order.avro.model.PaymentResponseAvroModel.Builder clearSagaId() {
			sagaId = null;
		 ...
		 * @return This builder.
		 */
		public ovh.migmolrod.food.ordering.system.kafka.order.avro.model.PaymentResponseAvroModel.Builder setPaymentId(java.lang.String value) {
		 ...
		 * @return This builder.
		 */
		public ovh.migmolrod.food.ordering.system.kafka.order.avro.model.PaymentResponseAvroModel.Builder clearPaymentId() {
			paymentId = null;
		 ...
		 * @return This builder.
		 */
		public ovh.migmolrod.food.ordering.system.kafka.order.avro.model.PaymentResponseAvroModel.Builder setCustomerId(java.lang.String value) {
		 ...
		 * @return This builder.
		 */
		public ovh.migmolrod.food.ordering.system.kafka.order.avro.model.PaymentResponseAvroModel.Builder clearCustomerId() {
			customerId = null;
		 ...
		 * @return This builder.
		 */
		public ovh.migmolrod.food.ordering.system.kafka.order.avro.model.PaymentResponseAvroModel.Builder setOrderId(java.lang.String value) {
		 ...
		 * @return This builder.
		 */
		public ovh.migmolrod.food.ordering.system.kafka.order.avro.model.PaymentResponseAvroModel.Builder clearOrderId() {
			orderId = null;
		 ...
		 * @return This builder.
		 */
		public ovh.migmolrod.food.ordering.system.kafka.order.avro.model.PaymentResponseAvroModel.Builder setPrice(java.math.BigDecimal value) {
		 ...
		 * @return This builder.
		 */
		public ovh.migmolrod.food.ordering.system.kafka.order.avro.model.PaymentResponseAvroModel.Builder clearPrice() {
			price = null;
		 ...
		 * @return This builder.
		 */
		public ovh.migmolrod.food.ordering.system.kafka.order.avro.model.PaymentResponseAvroModel.Builder setCreatedAt(java.time.Instant value) {
		 ...
		 * @return This builder.
		 */
		public ovh.migmolrod.food.ordering.system.kafka.order.avro.model.PaymentResponseAvroModel.Builder clearCreatedAt() {
		 ...
		 * @return This builder.
		 */
		public ovh.migmolrod.food.ordering.system.kafka.order.avro.model.PaymentResponseAvroModel.Builder setPaymentStatus(ovh.migmolrod.food.ordering.system.kafka.order.avro.model.PaymentStatus value) {
		 ...
		 * @return This builder.
		 */
		public ovh.migmolrod.food.ordering.system.kafka.order.avro.model.PaymentResponseAvroModel.Builder clearPaymentStatus() {
			paymentStatus = null;
		 ...
		 * @return This builder.
		 */
		public ovh.migmolrod.food.ordering.system.kafka.order.avro.model.PaymentResponseAvroModel.Builder setFailureMessages(java.util.List<java.lang.String> value) {
		 ...
		 * @return This builder.
		 */
		public ovh.migmolrod.food.ordering.system.kafka.order.avro.model.PaymentResponseAvroModel.Builder clearFailureMessages() {
		...
		public PaymentResponseAvroModel build() {
			try {
				...
				record.customerId = fieldSetFlags()[3] ? this.customerId :
				...
				record.paymentStatus = fieldSetFlags()[7] ? this.paymentStatus :
						(ovh.migmolrod.food.ordering.system.kafka.order.avro.model.PaymentStatus) defaultValue(fields()[7]);
